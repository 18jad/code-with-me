export const resetPassworHTML = (token: string) => {
  return `
    <!DOCTYPE html>
<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">

<head>
	<title>CodeWithMe | Reset Password</title>
											...
											<tr>
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-left: 10px; padding-right: 10px; vertical-align: top; padding-top: 5px; padding-bottom: 15px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="image_block block-3" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;padding-top:48px;">
																<div class="alignment" align="center" style="line-height:10px; border-radius: 11px;"><img src="https://i.ibb.co/0MhwJ8r/image.png" style="display: block; height: auto; border: 0; width: 174px; max-width: 100%; border-radius: 11px;" width="174" alt="Main Image" title="Main Image"></div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-bottom:20px;padding-left:15px;padding-right:15px;padding-top:20px;text-align:center;">
																<div class="alignment" align="center">
																	<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://localhost:3000/reset-password/${token}" style="height:39px;width:196px;v-text-anchor:middle;" arcsize="62%" stroke="false" fillcolor="#ffffff"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#091548; font-family:sans-serif; font-size:15px"><![endif]--><a href="http://localhost:3000/reset-password/${token}" target="_blank" style="text-decoration:none;display:inline-block;color:#091548;background-color:#ffffff;border-radius:24px;width:auto;border-top:0px solid transparent;font-weight:400;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:5px;padding-bottom:5px;font-family:Varela Round, Trebuchet MS, Helvetica, sans-serif;text-align:center;mso-border-alt:none;word-break:keep-all;"><span style="padding-left:25px;padding-right:25px;font-size:15px;display:inline-block;letter-spacing:normal;"><span style="word-break: break-word;"><span style="line-height: 30px;" data-mce-style><strong>RESET MY PASSWORD</strong></span></span></span></a>
														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:25px;padding-right:25px;padding-top:10px;">
																<div style="font-family: sans-serif">
																	...
																	<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;"><strong>Reset token is valid for 24 hours.</strong></p><br />
																		<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px; margin-bottom: 10px;"><strong>Didn’t request a password reset? You can safely ignore this message.</strong></p>
																</div>
															</td>
														</tr>
													</table>
													<table class="image_block block-11" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;padding-right:0px;padding-left:0px;padding-top:205px;">
																<div class="alignment" align="center" style="line-height:10px"><img class="big" src="https://media3.giphy.com/media/cPea2NiqqG7JHfOTj2/giphy.gif?cid=20eb4e9d8xfw3ptvgdf8k99sle5qz9vyncrs4gbocizn08tm&rid=giphy.gif&ct=s" style="display: block; height: auto; border: 0; width: 375px; max-width: 100%;" width="375" alt="Image" title="Image"></div>
															</td>
														</tr>
													</table>
												</td>
